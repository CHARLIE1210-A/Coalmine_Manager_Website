...
const Landing = () => {
  ...
  return (
    ...
    <div className="navbar"  onMouseLeave={hideOptions} style={{ display: 'inline-block', width: '100%' }}>
    ...
    <a href=""  onMouseEnter={login}> Login</a>
      <div >
      {showOptions && (
   <div className="overlay">
      <a href="" onClick={login1}>Area Manager</a>
      <a href=""onClick={login2}> Employe Register</a>
      <a href=""onClick={login3}>Employe Login</a>
    </div>
  )}
  </div> 
    </div>
